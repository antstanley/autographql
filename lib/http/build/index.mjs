...
/*#__PURE__*/
function () {
  var _ref2 = _asyncToGenerator(function* (_ref, port) {
    var {
      root,
      schema,
      resolvers,
    ...
    try {
      ...
      if (prepare(root)) {
        ...
        var bundleResponse = yield bundleResolvers(resolvers, resolverLoc, rollup, port);
  ...
  return function buildHttp(_x, _x2) {
