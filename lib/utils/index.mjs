...
import validateOpenId from './validateOpenId'; // import { dirname, join } from 'path'
...
export { removeFolder, copyFolderRecursiveSync, logger, rollupDefault, validateOpenId };